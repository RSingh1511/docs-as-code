...
.. tool_req:: Enforces presence of description
  ...
  :version: 1
  :implemented: YES
  :derived_from: gd_req__req_attr_description, gd_req__req_check_mandatory,
...
.. tool_req:: Metamodel
  ...
  Docs-as-Code shall provide a metamodel for defining config in a ``metamodel.yaml`` in the source code repository.
